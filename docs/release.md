...
No stable release exists yet. The current pre-release is `v0.1.0-rc.1`,
...
(`AUTODOC_VERSION=v0.1.0-rc.1`), see [install.md](install.md).

## Cutting a release candidate

```bash
git tag -a v0.1.0-rc.1 -m "AutoDoc v0.1.0-rc.1"
